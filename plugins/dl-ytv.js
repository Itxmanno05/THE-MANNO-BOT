...
const handler = async (m, {conn, args, usedPrefix, command}) => {
  ...
  try {
    ...
    const ttl_1 = `${yt_1?.title ? yt_1.title : '🄼 GRANTED-BY.CYBER_WARRIOR'}`;

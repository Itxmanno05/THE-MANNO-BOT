...
const handler = async (m, {conn, text, args, usedPrefix, command}) => {
  ...
  try {
    ...
    const desc1n = `*_🄼 GRANTED-BY.CYBER_WARRIOR_*`;
 ...
 m.react(done)
  ...
  try {
    ...
    const desc1 = `*_🄼 GRANTED-BY.CYBER_WARRIOR_*`;
  ...
  m.react(done)
    ...
    try {
      ...
      const desc2 = `*_🄼 GRANTED-BY.CYBER_WARRIOR_*`;
    ...
    m.react(done)
      ...
      try {
        ...
        const te = `*_🄼 GRANTED-BY.CYBER_WARRIOR_*`;
    ...
    m.react(done)
        ...
        try {
          ...
          const cap = `*_🄼 GRANTED-BY.CYBER_WARRIOR_*`;
